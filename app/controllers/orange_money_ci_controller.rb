class OrangeMoneyCiController < ApplicationController
  ...
  def index
    ...
    if @basket.blank?
      @basket = OrangeMoneyCiBasket.create(
        ...
        transaction_id: Digest::SHA1.hexdigest([DateTime.now.iso8601(6), rand].join)[0..10], 
        fees: @shipping, 
        rate: @rate, 
  ...
  def valid_transaction
    ...
    request = Typhoeus::Request.new(
      parameter.orange_money_ci_verify_url, 
      body: "merchantid=1f3e745c66347bc2cc9492d8526bfe040519396d7c98ad199f4211f39dfd6365&token=#{@token}", 
