          ...
          if (@status.to_s.downcase.strip == "1" || @status.to_s.downcase.strip == "succes")
            ...
            if request.post?
              ...
              if (@basket.operation.authentication_token rescue nil) == '3d20d7af-2ecb-4681-8e4f-a585d7700ee4'
                mobile_money_token = '1be8397d'
                reload_request = "#{Parameter.first.gateway_wallet_url}/api/86d138798bc43ed59e5207c664/mobile_money/cashin/Nsia/#{mobile_money_token}/#{@basket.paymoney_account_number}/#{@basket.original_transaction_amount}/0"
